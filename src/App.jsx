    ...
    <>
      ...
      {phase !== "start" && (
        <button
          ...
          className="fixed top-4 right-4 z-50 bg-[#590016] text-[#ffddc0] p-3 rounded-full shadow-md hover:bg-[#4c0013] transition border border-[#ffddc0] cursor-pointer active:scale-90"
        >
