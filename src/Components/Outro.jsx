...
function Outro({ onComplete }) {
  ...
  const messages = [
    ...
    `I've told you so many times why I love you so much and when I fell in love with you,`,
    `But today, I want to tell you,`,
    `Why I can't stop loving you.`,
    `Honestly speaking, even I don't know.`,
    `I guess there's something inside me,`,
    `Something that's always drawn to you,`,
    `That can't stop thinking about you,`,
    `That can't stop loving you.`,
    `And that feeling is holding me back,`,
    `Holding me back from moving on.`,
    `It's not like I never tried,`,
    `But I guess my love overrules my will,`,
    `And I'm perfectly happy with that.`,
    `I guess that’s a lot of talking…`,
    `If I keep going on like this,`,
    `The code will get too long and the slides will never end.`,
    `With all that said, it's time to say goodbye...`,
    `I hope you liked it,`,
